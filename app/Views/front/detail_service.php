...
<body>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map me-2"></i><?= is_array($value) ? $value['address'] : $value->address ?></small>
                    <small class="text-light"><i class="fa fa-phone me-2"></i><?= is_array($value) ? $value['phone'] : $value->phone ?></small>
                    &nbsp&nbsp<small class="text-light"><i class="fa fa-envelope-open me-2"></i><?= is_array($value) ? $value['email'] : $value->email ?></small>
                </div>
            </div>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Product And Solutions</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Product And Solutions</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        ...
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h1 class="mb-0">Product And Solutions</h1>
        </div>

        <!-- Menampilkan layanan ISP -->
        <div class="row g-4">
        ...
        <!-- Bagian untuk menampilkan layanan lain jika bukan ISP -->
        <?php if (empty($layanan)) : ?>
            <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="container py-5">
                    <div class="row g-5">
                        <div class="col-lg-8">
                            <!-- Blog Detail Start -->
                            <div class="mb-5">
                                <?php foreach ($layanan_other as $key => $value) : ?>
                                    <img class="img-fluid w-100 rounded mb-5" src="img/blog-1.jpg" alt="">
                                    <h1 class="mb-4"><?= is_array($value) ? $value['title'] : $value->title ?></h1>
                                    <p><?= is_array($value) ? $value['description'] : $value->title ?></p>
                                    <ul class="list-unstyled">
                                        <?php 
                                            $features = is_array($value) ? $value['features'] : $value->features;
                                            $featuresArray = json_decode($features, true); // Decode JSON menjadi array
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="wow slideInUp" data-wow-delay="0.1s">
                                <?php foreach ($profiles as $key => $value) : ?>
                                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                                        <h3 class="mb-0"><i><?= is_array($value) ? $value['company'] : $value->company ?></h3>
                                    </div>
                                    <div class="bg-light text-center" style="padding: 30px;">
                                        <p><i><?= is_array($value) ? $value['tagline'] : $value->tagline ?></p>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                            <!-- Plain Text End -->
