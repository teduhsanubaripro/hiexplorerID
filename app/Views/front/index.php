...
<link href="<?= base_url('template/fe/assets/styles/main_styles.css'); ?>" rel="stylesheet">
<link href="<?= base_url('template/fe/assets/styles/responsive.css'); ?>" rel="stylesheet">
</head>
...
<script src="<?= base_url('template/fe/assets/plugins/OwlCarousel2-2.2.1/owl.carousel.js'); ?>"></script>
<script src="<?= base_url('template/fe/assets/plugins/easing/easing.js'); ?>"></script>
<script src="<?= base_url('template/fe/assets/js/custom.js'); ?>"></script>
