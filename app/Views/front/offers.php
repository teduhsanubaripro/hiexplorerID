...
<link href="<?= base_url('template/fe/assets/styles/offers_styles.css'); ?>" rel="stylesheet">
<link href="<?= base_url('template/fe/assets/styles/offers_responsive.css'); ?>" rel="stylesheet">
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="template/fe/assets/images/about_background.jpg"></div>
			...
			<div class="row">
				...
				<div class="col-lg-12">
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image -->
										<div class="offers_image_background" style="background-image:url('<?= base_url('uploads/hotel/' . esc($hotel['image_url'])) ?>')"></div>
										<div class="offer_name">
											<a href="<?= base_url('offers/detail/' . urlencode($hotel['name'])) ?>"><?= esc($hotel['name']) ?></a>
										</div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_contents">
										...
										<p class="offers_text"><?= esc($hotel['description']) ?></p>
										<br>
										...
										<div class="button book_button"><a href="<?= base_url('offers/detail/' . urlencode($hotel['name'])) ?>">Book<span></span><span></span><span></span></a></div>
										<div class="offer_reviews">
											<div class="offer_reviews_content">
												<div class="offer_reviews_title text-center">
													<?php
					...
					<div class="pagination justify-content-center mt-4">
						<?= $pager->links('default', 'pagination_offers') ?>
					</div>
				</div>
