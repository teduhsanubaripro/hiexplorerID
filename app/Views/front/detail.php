...
<head>
    ...
    <link href="<?= base_url('template/fe/assets/lib/owlcarousel/assets/owl.carousel.min.css'); ?>" rel="stylesheet">
    <link href="<?= base_url('template/fe/assets/lib/animate/animate.min.css'); ?>" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?= base_url('template/fe/assets/css/bootstrap.min.css'); ?>" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<?= base_url('template/fe/assets/css/style.css'); ?>" rel="stylesheet">
</head>
...
<body>
    ...
    <!-- Template Javascript -->
    <script src="<?= base_url('template/fe/assets/js/main.js'); ?>"></script>
</body>
