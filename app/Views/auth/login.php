...
<head>
  ...
  <title>Login &mdash; AFNALINK</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?=site_url('auth/loginProcess')?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <a href="welcome" style="display: block; text-align: center; margin-top: 20px;">Back To Home?</a>
                  </div>
                </form>
            ...
            <div class="simple-footer">
              Copyright &copy; PT. AFNA DIGITAL INDONESIA
            </div>
          </div>
        </div>
      </div>
